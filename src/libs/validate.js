...
export function isIdCardNo(value) {
  ...
  return /^(\d{6})()?(\d{4})(\d{2})(\d{2})(\d{3})(\w)$/.test(value) && (birthday < new Date()) && isChinaID(value)
}
...
// 允许空的电话号码、手机号码
export function validatePhoneTelNull(rule, value, callback) {
...
// 允许空的电话号码、手机号码
export function validatePhoneTel(rule, value, callback) {
