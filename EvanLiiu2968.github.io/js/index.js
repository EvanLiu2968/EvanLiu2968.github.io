...
function getTime(){
    ...
    $(".time").eq(1).html(y+"年"+twoNumber(M)+"月"+twoNumber(D)+"日 "+weekday[d]+duration+twoNumber(th)+":"+twoNumber(m)+":"+twoNumber(s));
...
function videoPlayer(){
    ...
    $("#video-box").mouseover(function(){
        video_mask.css("transition","left 15s linear");
        video_mask.css("left","-100%");
    });
